module Gem
  ...
  ConsoleUI = Gem::ConsoleUI
  DEFAULT_HOST = "https://rubygems.org"
  DefaultUserInteraction = Gem::DefaultUserInteraction
  ...
  LOADED_SPECS_MUTEX = #<Mutex:0x007fab7c13b8a0>
  ...
  RUBYGEMS_DIR = "/opt/chefdk/embedded/lib/ruby/site_ruby/2.1.0"
  ...
  RubyGemsPackageVersion = "2.4.4"
  RubyGemsVersion = "2.4.4"
  RubyVersionMismatch = Gem::RubyVersionMismatch
  SilentUI = Gem::SilentUI
  Source = Gem::Source
  ...
  UserInteraction = Gem::UserInteraction
  VERSION = "2.4.4"
